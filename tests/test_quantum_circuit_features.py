...
def test_pauli_evolution_matches_qiskit_evolution_gate():
    ...
    circuit.h([0, 1])
    # A raw SparsePauliOp keeps Qiskit's label order only once it is imported.
    circuit.pauli_evolution(QiskitOperator.from_quantum_operator(operator), 0.37)
